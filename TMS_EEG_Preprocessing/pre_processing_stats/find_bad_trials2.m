function [bad_trials, n_neg] = find_bad_trials2(EEG, threshold_global, thresholds_local, nums_over_tresholds_local)
    data = EEG.data;
    ...
    bad_trials_general2 = find(z_scores < -threshold_global);
    ...
    n_neg = length(bad_trials_general2);
